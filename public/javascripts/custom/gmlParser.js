...
function GML2GeoJSON (gml, convert) { // eslint-disable-line
  if (convert === true) {
    ...
    if (padding === true) {
      ...
      if (convert === true) {
        for (var i = 0; i < arrayTableSeperator.length; i++) {
          arrayCommaSeperator[0].push(proj4(coordinateSystem, WGS84Param, [
      ...
      if (convert === true) {
        for (var w = 0; w < arrayTableSeperator.length; w++) {
          arrayCommaSeperator.push(proj4(coordinateSystem, WGS84Param, [
        ...
        if (key !== 'CG_GEOMETRY') {
          ...
          if (type === 'MultiPolygon') {
            ...
            if (convert === true) {
              ...
              obj.geometry.coordinates = [getCoord(coordsSingle, true, srs)]
            } else {
              obj.geometry.coordinates = [getCoord(coordsSingle, false)]
            }
            ...
            if (convert === true) {
              ...
              obj.geometry.coordinates = getCoord(lineCoordSingle, true, srs)
            } else {
              obj.geometry.coordinates = getCoord(lineCoordSingle, false)
            }
            ...
            if (convert === true) {
              ...
              obj.geometry.coordinates = getCoord(pointSingle, true, srs)[0]
            } else {
              obj.geometry.coordinates = getCoord(pointSingle, false)[0]
            }
          }
        }
      }
